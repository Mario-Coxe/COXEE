						...
						<div class="product-des">
							...
							<div class="short">
								...
								<div class="rating-main">
									...
									<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Comentário</a>
								</div>
								@php
								$after_discount=($product_detail->price-(($product_detail->price*$product_detail->discount)/100));
								@endphp
								<p class="price"><span class="discount">{{number_format($after_discount,2)}} AOA</span><s>{{number_format($product_detail->price,2)}} AOA</s> </p>
							...
							<div class="product-buy">
								...
								<p class="availability"> Estoque:
									@if($product_detail->stock > 0)
									@if($product_detail->stock < 5) <span class="badge badge-warning">Estoque baixo</span>
										@else
												...
												<div class="comment-review">
													...
													<div class="review-inner">
														...
														<p class="text-center p-5">
															Você precisa <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OU <a style="color:blue" href="{{route('register.form')}}">Register</a>
												...
												<div class="ratting-main">
													<div class="avg-ratting">
														{{-- @php 
																		...
																		@endphp --}}
														<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Geral)</span></h4>
