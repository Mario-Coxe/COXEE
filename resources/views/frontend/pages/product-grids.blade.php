                        ...
                        <div class="single-widget recent-post">
                            ...
                            <div class="single-post first">
                                ...
                                <div class="content">
                                    ...
                                    @endphp
                                    <p class="price"><del class="text-muted">{{number_format($product->price,2)}} AOA</del> {{number_format($org,2)}} AOA</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Olhada rápida" href="#"><i class=" ti-eye"></i><span>Visualizar Rápido</span></a>
                                            <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Favorito</span></a>
                                        </div>
                                        <div class="product-action-2">
                                            <a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Adicionar no carrinho</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-content">
                                    ...
                                    <del style="padding-left:4%;">{{number_format($product->price,2)}} AOA</del>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            $after_discount=($product->price-($product->price*$product->discount)/100);
                            @endphp
                            <h3><small><del class="text-muted">{{number_format($product->price,2)}} AOA</del></small> {{number_format($after_discount,2)}} AOA</h3>
