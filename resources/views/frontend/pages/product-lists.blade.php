    ...
    <section class="product-area shop-sidebar shop-list shop section">
        <div class="container">
            <div class="row">
                        ...
                        <div class="single-widget range">
                            ...
                            <div class="price-filter">
                                <div class="price-filter-inner">
                                    ...
                                    @endif' placeholder="Adicione seu preço"/>
                                </div>
                            </div> --}}
                            @php
                            ...
                            // dd($max);
                            @endphp
                            <div id="slider-range" data-min="1000" data-max="{{$max}}"></div>
                ...
                <div class="single-widget recent-post">
                    <h3 class="title">Recentementes</h3>
                    {{-- {{dd($recent_products)}} --}}
        ...
        <div class="col-lg-9 col-md-8 col-12">
            ...
            <div class="row">
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Olhada rápida"
                                            ...
                                            <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}"
                                                class="wishlist" data-id="{{$product->id}}"><i
                                                    class=" ti-heart "></i><span>Favorito</span></a>
                                        </div>
                                        <div class="product-action-2">
                                            <a title="Add to cart"
                                                href="{{route('add-to-cart',$product->slug)}}">Comprar
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="list-content">
                                <div class="product-content">
                                    <div class="product-price">
                                        ...
                                        <del>{{number_format($product->price,2)}} AOA</del>
                                    </div>
                                    <h3 class="title"><a
                                ...
                                <a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">COMPRAR</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @endforeach
                @else
                <h4 class="text-danger" style="margin:100px auto;">Nenhum encontrado!</h4>
                @endif
            </div>
            <div class="row">
