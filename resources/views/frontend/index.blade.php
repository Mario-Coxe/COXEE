        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-banner">
                    ...
                    <div class="content">
                        <h3>{{$cat->title}}</h3>
                        <a href="{{route('product-cat',$cat->slug)}}">VER</a>
                    </div>
                </div>
            </div>
            @endif
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{route('product-detail', $product->slug)}}">
                                        ...
                                        @if($product->stock <= 0) <span class="out-of-stock">Vendido</span>
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-price">
                                        <span>{{number_format($after_discount, 2)}} A0A</span>
